...
beginfig(1);
    ...
    defaultscale := 8;
    %label.lrt("NUMO", (4(w + space),4h + 3space)) withcolor golden;
    label.lrt(btex \vbox{\hbox{NUMO}\hbox{DATA}} etex scaled 8 , (4(w + space),4h + 3space)) withcolor golden;
    % label.lrt("NUMO" infont "cmssbx10" scaled 5, (4(w + space),4h + 3space)) withcolor golden;
    % label.lrt("NUMO" infont "ugq" scaled 5, (4(w + space),4h + 3space)) withcolor golden;
    defaultfont:="cmss10";
    %label.lrt(btex \font\foo=cmssbx10 \foo NUMO etex  scaled 5, (4(w + space),4h + 3space)) withcolor golden;
    % label.lrt(btex \font\foo=cmss10 \foo NUMO etex  scaled 5, (4(w + space),2h + space)) withcolor golden;
endfig;

beginfig(2);
    fill unitsquare xscaled 10w yscaled 5h shifted (-space, -space) withcolor dark_navy;
    fill whole_path((0,0), (1,0)) withcolor golden;
    fill whole_path((0, 1), (0, 2)) withcolor golden;
    fill whole_path((0, 3), (1, 3), (2, 3), (3, 3), (3, 2)) withcolor golden;
    fill whole_path((1 ,1), (2 ,1)) withcolor golden;
    fill whole_path((1, 2), (2, 2)) withcolor golden;
    fill whole_path((2, 0), (3, 0), (3, 1)) withcolor golden;
endfig;
end;
\end{mplibcode}
\end{document}